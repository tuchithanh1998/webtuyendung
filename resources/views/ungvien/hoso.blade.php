	...
	<div class="col-sm-12 " style="margin-top: 25px; margin-bottom: 25px;">
		<div class="card  ">
			...
			<div class="card-body">
				<div class="row">
					<div class="col-6">
						<p class="card-text"><span class="font-weight-bold">MSWORD :</span><?php 
						if(Auth::guard('ungvien')->user()->trinhdotinhoc[0]->msword!="")	{	if(Auth::guard('ungvien')->user()->trinhdotinhoc[0]->msword==1)
							{echo "Tốt";}
						...
						?> </p>
						<p class="card-text"><span class="font-weight-bold">MSPP :</span><?php 
						if(Auth::guard('ungvien')->user()->trinhdotinhoc[0]->mspp!="")	{			if(Auth::guard('ungvien')->user()->trinhdotinhoc[0]->mspp==1)
						...
						<div class="col-6">
							<p class="card-text"><span class="font-weight-bold">MSOUTLOOK :</span><?php Auth::guard('ungvien')->user()->trinhdotinhoc[0]->msoutlook!=""{ if(Auth::guard('ungvien')->user()->trinhdotinhoc[0]->msoutlook==1)
							...
							?> </p><p class="card-text"><span class="font-weight-bold">MSEXCEL :</span><?php 
							if(Auth::guard('ungvien')->user()->trinhdotinhoc[0]->msexcel!="")	{		if(Auth::guard('ungvien')->user()->trinhdotinhoc[0]->msexcel==1)
